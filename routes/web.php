...
Route::get('mahatma-gandhi-human-right', [AwardController::class, 'mghra'])->name('mghra');
Route::get('bhim-rao-ambedkar-award', [AwardController::class, 'braa'])->name('braa');
Route::get('nhrccb-pride-award', [AwardController::class, 'nirpd'])->name('nirpd');
...
Route::post('/verifymember', [PageController::class, 'verifymember'])->name('verifymember');
