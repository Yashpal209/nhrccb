    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewCovid19')}}"><div class="btn">
                                View Covid19
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('postCovid19')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="file-field input-field col s12">
                                <div class="btn admin-upload-btn">
                                    ...
                                    <input type="file" name="covid_img">
                                </div>
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload Covid19 Image" accept="image/png, image/jpeg, image/jpg, image/webp">
                                </div>
