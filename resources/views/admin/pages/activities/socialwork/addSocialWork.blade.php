            ...
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        <div class="col-md-6">
                            <h4>Add Social Work</h4>
                        </div>
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewSocialWork')}}"><div class="btn">
                                View Social Work
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('postSocialWork')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="file-field input-field col s12">
                                <div class="btn admin-upload-btn">
                                    ...
                                    <input type="file" name="social_wrk_img">
                                </div>
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload Social Work Image" accept="image/png, image/jpeg, image/jpg, image/webp">
                                </div>
