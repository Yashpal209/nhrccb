            ...
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        <div class="col-md-6">
                            <h4>Add Office Staff</h4>
                        </div>
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewOfficestaff')}}"><div class="btn">
                                View Office Staff
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('OfficeStaffPost')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <div class="file-field input-field col s6">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload Office Staff Image" accept=".jpg, .png, .jpeg|image/*">
                                </div>
