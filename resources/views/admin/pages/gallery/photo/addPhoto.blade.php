    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-inn-sp admin-form">
                ...
                <div class="tab-inn">
                    <form action="{{route('postPhoto')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="file-field input-field col s4">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder=" Image" accept="image/png, image/jpeg, image/jpg, image/webp">
                                </div>
                            </div>
