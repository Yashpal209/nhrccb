            ...
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        <div class="col-md-6">
                            <h4>Add Police Letter</h4>
                        </div>
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewPoliceLetter')}}"><div class="btn">
                                View Police Letter
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('postPoliceLetter')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="file-field input-field col s12">
                                <div class="btn admin-upload-btn">
                                    ...
                                    <input type="file" name="pol_let_img">
                                </div>
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload  Police Letter Image" accept="image/png, image/jpeg, image/jpg, image/webp">
                                </div>
