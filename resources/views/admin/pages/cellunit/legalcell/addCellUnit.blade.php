            ...
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        <div class="col-md-6">
                            <h4>Add Legal Cell</h4>
                        </div>
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewLegalCell')}}"><div class="btn">
                                View Legal Cell
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('postLegalCell')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="file-field input-field col s12">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload Legal Cell Image" accept=".jpg, .png, .jpeg|image/*">
                                </div>
