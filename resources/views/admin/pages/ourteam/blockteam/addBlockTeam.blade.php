            ...
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        <div class="col-md-6">
                            <h4>Add Block Team</h4>
                        </div>
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewBlockTeam')}}"><div class="btn">
                                View Block Team
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('postBlockTeam')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="input-field col s6">
                                <input type="text" name="block_name" class="validate" required>
                        ...
                        <div class="input-field col s6">
                            ...
                            <div class="file-field input-field col s6">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload Block Team Image" accept=".jpg, .png, .jpeg|image/*">
                                </div>
