    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewVolunteer')}}"><div class="btn">
                                View Volunteer
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('postVolunteer')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="file-field input-field col s6">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload Volunteer Image" accept=".jpg, .png, .jpeg|image/*">
                                </div>
