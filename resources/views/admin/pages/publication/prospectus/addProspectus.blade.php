            ...
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        <div class="col-md-6">
                            <h4>Add Prospectus</h4>
                        </div>
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewProspectus')}}"><div class="btn">
                                View Prospectus
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('postProspectus')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="file-field input-field col s12">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload Prospectus" accept="image/png, image/jpeg, image/jpg, image/webp">
                                </div>
