    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-inn-sp admin-form">
                <div class="inn-title">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 text-right">
                           <a href="{{route('viewSouvenier')}}"><div class="btn">
                                View Souvenier
                            </div></a> 
                        </div>
                    </div>
                ...
                <div class="tab-inn">
                    <form action="{{route('postSouvenier')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="file-field input-field col s12">
                                <div class="btn admin-upload-btn">
                                    ...
                                    <input type="file" name="souvenier">
                                </div>
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="Upload Souvenier" accept="image/png, image/jpeg, image/jpg, image/webp">
                                </div>
