                ...
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="n-form-com admiss-form">
                        <div class="col s12">
                            <div class="card py-3">
                                <div class="card-body">
                                    <form class="form-horizontal" action="{{route('postNewComplainForm')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row justify-content-center border-bottom mb-3 mb-sm-0 px-4 px-sm-0">
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" name="name" id="name" class="form-control" placeholder="Enter name as per Aadhaar" require>
                                                        @error('name')
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="number" name="mobile" id="mobile" class="form-control" placeholder="Enter Mobile Number" require>
                                                        @error('mobile')
                                                        <span class="text-danger">
                                                            {{ $message }}
                                                        </span>
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <select class="form-control" name="complain_type" id="complain_type" require>
                                                            ...
                                                            <option value="schedule-cast-rights">Schedule Cast Rights</option>
                                                            <option value="schedule-tribe-rights">Schedule Tribe Rights</option>
                                            ...
                                            <div class="col-md-5 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <textarea type="text" rows="3" name="address" id="address" class="form-control" placeholder="Enter Address" require></textarea>
                                                        @error('address')
                                                        <span class="text-danger">
                                                            {{ $message }}
                                                        </span>
                                            ...
                                            <div class="col-md-10 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="complain_details" id="exampleFormControlTextarea1" placeholder="Write Your Complain" rows="6"></textarea>
                                            ...
                                            <div class="col-md-7 col-sm-12 col-xs-12 my-2">
                                                    <div class="file-field input-field">
                                                        ...
                                                        <div class="file-path-wrapper">
                                                            <input class="file-path validate" type="text" placeholder="Upload Attachment (if any)">
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>
