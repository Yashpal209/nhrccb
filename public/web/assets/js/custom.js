$(document).ready(function() {
    ...
    $(".event-menu").mouseleave(function() {
        $(".event-mm").fadeOut();
    });

    $(".complain-menu").hover(function() {
        $(".complain-mm").fadeIn();
    });
    $(".complain-menu").mouseleave(function() {
        $(".complain-mm").fadeOut();
    });

    $(".registration-menu").hover(function() {
        $(".registration-mm").fadeIn();
    });
    $(".registration-menu").mouseleave(function() {
        $(".registration-mm").fadeOut();
    });
    ...
    //ISSUE MENU	
    $(".issue-menu").hover(function() {
        $(".issue-mm").fadeIn();
    });
    $(".issue-menu").mouseleave(function() {
        $(".issue-mm").fadeOut();
    });
    ...
    $(".activity-menu").mouseleave(function() {
        $(".activity-mm").fadeOut();
    });

    //Our Team MENU	
    $(".ourteam-menu").hover(function() {
        $(".ourteam-mm").fadeIn();
    });
    $(".ourteam-menu").mouseleave(function() {
        $(".ourteam-mm").fadeOut();
    });

    //Our Cell Unit	
    $(".ourcellunit-menu").hover(function() {
        $(".ourcellunit-mm").fadeIn();
    });
    $(".ourcellunit-menu").mouseleave(function() {
        $(".ourcellunit-mm").fadeOut();
    });
    //Complain Unit	
    $(".complain-menu").hover(function() {
        $(".complain-mm").fadeIn();
